...
helm.sh/chart: {{ include "mcp-backend.chart" . }}
...
*/}}
{{- define "mcp-backend.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "mcp-backend.fullname" .) .Values.serviceAccount.name }}
{{- else }}
